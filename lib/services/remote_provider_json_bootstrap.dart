...
class RemoteProviderJsonBootstrap {
  ...
  Future<void> prepare() async {
    try {
      ...
      // La app debe seguir abriendo incluso si GitHub o la red no responden.
      // LocalProviderJsonStore valida antes de reemplazar, por lo que la última
      // copia funcional permanece disponible.
    }
  }
}
