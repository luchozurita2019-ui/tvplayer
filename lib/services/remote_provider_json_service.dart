...
/// Fuente remota integrada para la prueba V48.
///
/// La URL queda compilada dentro de la APK, pero puede reemplazarse en CI con
/// --dart-define=TV_FULL_PROVIDER_JSON_URL=... sin tocar el reproductor.
///
/// Importante: esta capa NO convierte ni utiliza valores DRM embebidos del
/// catálogo remoto. Para esta prueba sólo normaliza el feed y deja Media3 sin
/// material DRM proveniente del JSON remoto. La integración DRM autorizada se
/// mantiene separada del transporte del catálogo.
class RemoteProviderJsonService {
  ...
  static const _userAgent =
      'TV-FULL-PRO/1.4.16 (Android TV; provider-json-v48)';
    ...
    try {
      ...
      for (final rawCategory in decoded['categories'] as List) {
        ...
        for (final rawSample in rawCategory['samples'] as List) {
          ...
          // No llevar material DRM del repositorio remoto a Channel. El resto
          // de los metadatos (URL, headers, logos, categoría y tipo) se conserva.
