...
# Regex replacement turned the intended Kotlin escape sequence into a real line break.
actual_broken = 'Vinculá este televisor desde el panel de TV FULL.\nLas listas y servicios se cargarán automáticamente.'
fixed = 'Vinculá este televisor desde el panel de TV FULL.\\nLas listas y servicios se cargarán automáticamente.'
