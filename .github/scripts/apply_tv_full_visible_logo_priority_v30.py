...
cached = Path('lib/widgets/cached_artwork_image.dart')
cached.write_text(r'''import 'dart:async';
import 'dart:io';
...
catalog = Path('lib/widgets/tv_live_premium_catalog.dart')
...
replace_once('pubspec.yaml', 'version: 1.3.7+29', 'version: 1.3.8+30')
print('Applied TV FULL PRO 1.3.8+30 visible-first logo optimization')
